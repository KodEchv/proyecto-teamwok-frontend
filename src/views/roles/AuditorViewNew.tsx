...
export const AuditorViewNew: React.FC = () => {
    return (
        <>
            <Navbar activeLink="auditor" />

            <main className="container mt-5 pt-5 text-center">
                <h2 className="fw-bold text-primary mb-4">Panel del Auditor de Videos</h2>
                <p>Monitorea la calidad y cumplimiento de las auditorías mediante este tablero dinámico.</p>
